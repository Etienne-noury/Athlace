...
GRANT EXECUTE ON FUNCTION public.map_club_clusters(double precision, double precision, double precision, double precision, double precision, text[], text[], text) TO anon, authenticated, service_role;